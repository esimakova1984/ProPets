...
import style from '../../CSS_modules/ServiceFostering.module.css';
...
import manWithCat from '../../Images/manWithCat.png';
                            ...
                            <div className={`row`}>
                                ...
                                <div className={`ml-3 mr-3 mt-3 ${style.content}`}>
                                    ...
                                    <div className={`col-lg-8 m-auto`}>
                                        <img className={`mb-2 mt-2 ${style.manWithCat}`} src={manWithCat}
                                             alt='manWithCat'/>
