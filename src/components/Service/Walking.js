...
import style from '../../CSS_modules/ServiceWalking.module.css';
...
import aLotOfDogs from '../../Images/aLotOfDogs.png';
        ...
        <div className={`container-fluid`}>
            ...
            <div className={`container-fluid`}>
                <div className={style.main}>
                    <div className={`row`}>
                        <nav className={` navbar navbar-expand-lg  navbar-dark fixed-left col-lg-3 ${style.navigation}`}>
                        ...
                        <div className={`col-lg-6 ${style.body}`}>
                            <div className={`row`}>
                                <div className={`ml-5 mt-3 ${style.headerContent}`}>
                                    <span><b>Fostering.</b> In adoption we trust.</span>
                                </div>
                                <div className={`ml-3 mr-3 mt-3 ${style.content}`}>
                                    ...
                                    <div className={`col-lg-8 m-auto`}>
                                        <img className={`mb-2 mt-2 ${style.aLotOfDogs}`} src={aLotOfDogs} alt='aLotOfDogs'/>
